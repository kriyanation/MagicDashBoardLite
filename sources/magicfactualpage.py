...
class MagicFactualPage(tk.Frame):
    ...
    def resize_c(self,event):
        ...
        elif hasattr(self,"image1")  and self.factual_index == 1 and self.winfo_width()/2.1 - 100> 0 and self.winfo_height()/1.6 -100 > 0:
        ...
        elif hasattr(self,"image1")  and self.winfo_width()/2.1 - 100> 0 and self.winfo_height()/1.6 -100:
    ...
    def save_image_window(self,canvas,factualterm):
        ...
        messagebox.showinfo("Full Version", "Available with full version", parent=self)
