...
class MagicApplication(tk.Toplevel):
    def __init__(self, *args, **kwargs):
        ...
        self.lbbutton_hide = ttk.Button(self.tool_frame,text="Leader Board", command=self.show_leaderboard,
                                        style='Green.TButton')
    ...
    def show_leaderboard(self):
        messagebox.showinfo("Full Version", "Available in Full version",parent=self)
